					...
					<!-- start: page -->
								...
								<section class="panel">
									...
									<div class="panel-body">
												<form id="form_vistatab" class="form-horizontal form-bordered" method="post" action="consulta-filtro1.php" autocomplete="off">
														<div class="panel-body">
															<div class="row">
																<div class="col-sm-6">
