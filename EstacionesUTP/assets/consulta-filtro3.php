				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
								...
								if(@$buscar)
								{
									...
									$resultado3=funciones::consultarFiltro3($estacion,$agente,$fecha_start2,$fecha_end2);
									//echo $estacion.", ".$agente.", ".$fecha_start.", ".$fecha_end;
								}
								?>
								...
								<section class="panel">
									...
									<div class="panel-body">
												<form id="form_vistatab" class="form-horizontal form-bordered" method="post" action="consulta-filtro3.php" autocomplete="off">
														<div class="panel-body">
															<div class="row">
																<div class="col-sm-6">
