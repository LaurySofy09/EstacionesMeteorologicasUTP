...
<html class="fixed">
	<head>
		...
		<title>Consultar Estación</title>
													...
													<table class="table table-hover mb-none">
														...
														echo "<thead>";
															...
															echo "<tr>";
																...
																echo "<th>ID del lugar</th>";

																echo "<th>Coordenada X</th>";

																echo "<th>Coordenada Y</th>";
														...
														echo "<tbody>";
															...
															echo "<tr>";
																...
																echo "<td>".$row['ID_LUGAR']."</td>";

																echo "<td>".$row['COORD_X']."</td>";

																echo "<td>".$row['COORD_Y']."</td>";
