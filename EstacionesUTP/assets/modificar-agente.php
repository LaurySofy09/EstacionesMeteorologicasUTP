				...
				<section role="main" class="content-body">
					...
					<?php
						...
						if(@$guardar)
						{
			                ...
			                $resultado=funciones::modificarAgente($id,$idd,$cla,$nom,$est);
			                if($resultado==0)
			                {
			                    $op=3;
			                }
					    ...
					    if (@$buscar) {
							$id = $_POST["id"];
							$resultado=funciones::buscarAgente($id);
							if($resultado == 0)
							{
								$op=1;
							}
						...
						<div class="row">
							<div class="col-lg-12">
								<section class="panel">
									...
									<form action="modificar-agente.php" class="form-horizontal form-bordered" method="post">	
										<div class="panel-body">
											...
											<div class="form-group">
												<label class="col-md-4 control-label" for="inputDefault">Nomenclatura</label>
												<div class="col-md-3">
													<?php
													echo '<input type="text" class="form-control" name="cla" id="cla" value='.@$cla.'>';
													?>
												</div>
											</div>
