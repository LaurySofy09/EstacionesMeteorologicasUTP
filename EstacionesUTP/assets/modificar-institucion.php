			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					if (@$guardar) {
						...
						$resultado=funciones::modificarInstitucion($id,$idd,$nom,$tel,$email,$est);
						if ($resultado == 0) {
							$op = 4;
						}
						else
					...
					if (@$buscar) {
						$id = $_POST["id"];
						$resultado=funciones::buscarInstitucion($id);
						if($resultado == 0)
						{
							$op=1;
						}
						...
						<div class="row">
							<div class="col-lg-12">
								<section class="panel">
									...
									<form class="form-horizontal form-bordered" method="post" action="modificar-institucion.php">
										<div class="panel-body">
											...
											<div class="form-group">
												<label class="col-md-4 control-label" for="inputDefault">Nombre de la institución</label>
												<div class="col-md-3">
													<?php
														echo '<input type="text" class="form-control" id="inputDefault" name = "nom" value = "'.@$nom.'">';
													?>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 control-label" for="inputPlaceholder">Teléfono</label>
												<div class="col-md-3">
													<?php
														echo '<input type="text" class="form-control" placeholder="999-9999" id="inputPlaceholder" name="tel" value='.@$tel.'>';
													?>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 control-label" for="inputPlaceholder">Correo eléctronico</label>
												<div class="col-md-3">
													<?php
														echo '<input type="text" class="form-control" placeholder="ejemplo@correo.com" id="inputPlaceholder" name="email" value='.@$email.'>';
													?>
												</div>
											</div>
											<div class="form-group">
