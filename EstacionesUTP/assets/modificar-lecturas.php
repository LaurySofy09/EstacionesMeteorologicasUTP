...
<html class="fixed">
	<head>
		...
		<title>Modificar Lecturas</title>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					if (@$guardar) {
						$id = $_POST["id"];
						$idd = $_POST["idd"];
						$esta = intval($_POST["esta"]);
						$agen = intval($_POST["agen"]);
						$prom = $_POST["prom"];
						$fecha = $_POST["fecha"];
						$fecha2 = $fecha." ".$hora;
						$resultado=funciones::modificarLectura($id,$idd,$esta,$agen,$prom,$fecha2);
						if ($resultado == 0) {
							$op = 3;
						}
						else
					...
					if (@$buscar) {
						$id = $_POST["id"];
						$resultado=funciones::buscarLectura($id);
						if($resultado == 0)
						{
							$op=1;
						}
						...
						<div class="row">
							<div class="col-lg-12">
								<section class="panel">
									...
									<form class="form-horizontal form-bordered" method="post" action="modificar-lecturas.php">
										<div class="panel-body">
											<div class="form-group">
												...
												<div class="col-md-2">
													<div class="input-group">
														<?php
															$resultado=funciones::consultarLectura();
												...
												<div class="col-md-4">
													<?php
														$resultado=funciones::consultarEstacion();
															echo '<select class="form-control mb-md" name = "esta">';
															foreach ($resultado as $row) {
																if(@$esta == $row['ID'])
																{
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<?php
													$resultado=funciones::consultarAgente();
															echo '<select class="form-control mb-md" name = "agen">';
															foreach ($resultado as $row) {
																if(@$agen == $row['ID'])
																{
																	echo '<option selected>'.$row['ID'].' - '.$row['NOMBRE'].'</option>';
																}
																else
																{
											...
											<div class="form-group">
												<label class="col-md-4 control-label" for="inputDefault">Promedio</label>
												<div class="col-md-3">
													<?php
														echo '<input type="text" class="form-control" id="inputDefault" name = "prom" value = '.@$prom.'>';
													?>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<?php
														echo '<input type="time" class="form-control" id="inputDefault" step="3600" name="hora" value='.@$hora.'>';
