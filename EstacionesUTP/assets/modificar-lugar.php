				...
				<section role="main" class="content-body">
					...
					@$guardar = $_POST["guardar"];
						...
						if(@$guardar)
						{
			                ...
			                $resultado=funciones::modificarLugar($id,$idd,$nom,$tel,$dir,$est);
			                if($resultado==0)
			                {
			                    $op=3;
			                }
					    ...
					    if (@$buscar) {
							$id = $_POST["id"];
							$resultado=funciones::buscarLugar($id);
							if($resultado == 0)
							{
								$op=1;
							}
						...
						<div class="row">
							<div class="col-lg-12">
								<section class="panel">
									...
									<form action="modificar-lugar.php" class="form-horizontal form-bordered" method="post">
										<div class="panel-body">
											...
											<div class="form-group">
												<label class="col-md-4 control-label" for="inputDefault">Teléfono</label>
												<div class="col-md-3">
													<div class="input-group">
															<span class="input-group-addon">
															...
															<?php
															echo '<input name="tel" id="tel" data-plugin-masked-input class="form-control" value="'.@$tel.'"/>';
															?>
														</div>
												</div>
											</div>
											...
											<div class="form-group">
												<label class="col-md-4 control-label" for="textareaAutosize">Dirección</label>
												<div class="col-md-5">
													<?php
													echo '<textarea class="form-control" rows="3" id="dir" name="dir" data-plugin-textarea-autosize>'.@$dir.'</textarea>';
													?>
												</div>
											</div>
